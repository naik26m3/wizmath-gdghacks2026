...
export default function Activities() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: BG, color: '#d7e4f1', fontFamily: 'Manrope,sans-serif' }}>
      ...
      {justPublishedId && (
        <div style={{ maxWidth:1240, margin:'24px auto 0', padding:'12px 20px', background:'rgba(67,226,210,.08)', border:`1px solid rgba(67,226,210,.3)`, borderRadius:8, color:'#43e2d2', fontFamily:'Space Grotesk,sans-serif', fontSize:13, display:'flex', alignItems:'center', gap:10 }}>
      ...
      <div style={{ maxWidth:1240, margin:'24px auto 0', padding:'0 40px 12px', display:'flex', alignItems:'baseline', gap:14 }}>
      ...
      <div style={{ maxWidth:1240, margin:'0 auto', padding:'0 40px 80px', display:'grid', gridTemplateColumns:'repeat(auto-fill,minmax(300px,1fr))', gap:24 }}>
        {published.length === 0 && pubStatus === 'ok' && (
          <div style={{ gridColumn:'1 / -1', padding:'40px', textAlign:'center', color:'#555', fontFamily:'Manrope,sans-serif', fontSize:14, border:`1px dashed ${BORDER}`, borderRadius:10 }}>
